...
public:
	...
	void        UninitPort(void);
	// start/stop comm watching
	BOOL		StartMonitor(void);
	BOOL		ResumeMonitor(void);
	BOOL		SuspendMonitor(void);
	...
	void		WriteToPort(unsigned char* writebuf, unsigned long buflen);
	void        WriteSerial(const unsigned char* buf, unsigned char len);
protected:
