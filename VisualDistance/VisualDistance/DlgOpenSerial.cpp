...
CDlgOpenSerial::CDlgOpenSerial(CWnd* pParent /*=NULL*/)
	: CDialogEx(IDD_DLG_OPEN_SERIAL, pParent)
	, m_nBoudRateIdx(0)
{
...
BEGIN_MESSAGE_MAP(CDlgOpenSerial, CDialogEx)
	...
	ON_CBN_SELCHANGE(IDC_CMB_STOPBITS, &CDlgOpenSerial::OnCbnSelchangeCmbStopbits)
	ON_WM_CTLCOLOR()
END_MESSAGE_MAP()
...
void CDlgOpenSerial::OnCbnSelchangeCmbStopbits()
{
	KillTimer(1);
	SetDlgItemText(IDC_STATIC_OPEN_SERIAL_TIP, _T(""));
}
