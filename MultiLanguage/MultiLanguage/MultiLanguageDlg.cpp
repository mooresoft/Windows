...
// CMultiLanguageDlg 对话框




CMultiLanguageDlg::CMultiLanguageDlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(CMultiLanguageDlg::IDD, pParent)
{
...
BEGIN_MESSAGE_MAP(CMultiLanguageDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
END_MESSAGE_MAP()
